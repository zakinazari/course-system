...
return new class extends Migration
{
    ...
    {
        Schema::create('temporary_payrolls', function (Blueprint $table) {
            $table->id();
            $table->foreignId('employee_id')->constrained('employees');
            $table->foreignId('branch_id')->constrained('branches');
            $table->foreignId('temporary_contract_id')->constrained('temporary_contracts');
    ...
    {
        Schema::dropIfExists('temporary_payrolls');
    }
};
