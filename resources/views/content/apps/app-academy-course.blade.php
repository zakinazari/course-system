...
@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Academy/</span> My Courses</h4>
  ...
  <div class="card p-0 mb-4">
    <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
      ...
      <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center">
        <h3 class="card-title mb-4 lh-sm px-md-5">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card p-2 h-100">
            ...
            <div class="card-body p-3 pt-2">
              ...
              <a class="w-100 btn btn-label-primary" href="{{url('app/academy/course-details')}}"><i class="bx bx-sync me-2"></i>Start Over</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
