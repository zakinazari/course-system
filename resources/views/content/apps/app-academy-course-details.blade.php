...
@section('content')
<h4 class="pt-3 breadcrumb-wrapper">
    ...
    <div class="col-lg-8">
      ...
      <div class="card academy-content">
        ...
        <div class="card-body">
          ...
          <h5>Description</h5>
          <p class="mb-4">
            he material of this course is also covered in my other course about web design and development
          ...
          <div class="d-flex justify-content-start align-items-center user-name">
            <div class="avatar-wrapper">
              <div class="avatar avatar-sm me-2"><img src="{{asset('assets/img/avatars/11.png')}}" alt="Avatar" class="rounded-circle"></div>
            </div>
