                    ...
                    <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="#" wire:click.prevent="exportExcel">
                                <i class="fa fa-file-excel"></i> {{ __('label.export_to_excel') }}
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="#" wire:click.prevent="exportPdf">
                                <i class="fa fa-file-pdf"></i> {{ __('label.export_to_pdf') }}
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mb-3 px-3">
                <form wire:submit.prevent="applySearch" class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <input type="text" class="form-control" placeholder="{{ __('label.role_name') }}" wire:model="search.role_name">
                    </div>
                    <div class="col-md-2">
                                ...
                                <div class="dropdown position-static">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @if(delete(Auth::user()->role_ids,$active_menu_id))
                                            <a class="dropdown-item " href="javascript:void(0);"  onclick="confirmDelete({{ $role->id }},'{{$table_name}}')"
            ...
            <div class="modal-content">
                ...
                <form @if($editMode) wire:submit.prevent="update" @else wire:submit.prevent="store" @endif>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nameBasic" class="form-label">{{ __('label.role_name') }}</label>
                                <input type="text" id="nameBasic" class="form-control @error('role_name') is-invalid @enderror" wire:model.lazy="role_name">
                                @error('role_name') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
