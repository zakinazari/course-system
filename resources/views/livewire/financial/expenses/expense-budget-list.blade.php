                ...
                <table class="table">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>
                                {{ __('label.effective_from') }}
                            </th>
                            <th>
                                {{ __('label.effective_to') }}
                            </th>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($expense_budgets as $i => $expense)
                        <tr>
                            <td>{{ ($expense_budgets->currentPage() - 1) * $expense_budgets->perPage() + $i + 1 }}</td>
                            ...
                            <td>{{ $expense->effective_from?->format('Y/m/d') }}</td>
                            <td>{{ $expense->effective_to?->format('Y/m/d') }}</td>
                ...
                <form @if($editMode) wire:submit.prevent="update" @else wire:submit.prevent="store" @endif>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                <label for="nameBasic" class="form-label">{{ __('label.effective_from') }} <span style="color:red;">*</span></label>
                                <input type="date" id="nameBasic" class="form-control @error('effective_from') is-invalid @enderror" wire:model.lazy="effective_from">
