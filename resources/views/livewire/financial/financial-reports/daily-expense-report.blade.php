            ...
            <div class="mb-2 px-2 mb-5">
                <form wire:submit.prevent="applySearch" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 d-flex flex-column" wire:ignore>
                        ...
                        <select class="form-select select2" wire:model.lazy="search.category" id ="search_category_id">
                        <option value="">{{ __('label.all') }}</option>
                        @foreach($expense_categories as $category)
                                @if($category->value!='book_purchase')
                ...
                <hr>
                  <div id="printArea">
                    <!-- Logo -->
                        ...
                        @includeIf('livewire.financial.financial-reports.financial-report-records.expense-records.' . $records_view, [
