        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mb-3 px-3">
                <form wire:submit.prevent="applySearch" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        <label class="form-label">{{ __('label.exam_type') }}</label>
                        <select class="form-select" wire:model.lazy="search.exam_type_id">
                            <option value="">{{ __('label.all') }}</option>
                           @foreach($exam_types as $exam_type)
                                 <option value="{{ $exam_type->id }}"  wire:key="exam-type-search-{{ $exam_type->id }}">
                                    {{ $exam_type->name }}
                                 </option>
                           @endforeach
                        </select>
                    ...
                    @if($course_message)
                        <div class="invalid-feedback d-block">{{ $course_message }}</div>
                    @endif
                    @if($exam_type_message)
                        <div class="invalid-feedback d-block">{{ $exam_type_message }}</div>
                    @endif
                </form>
            </div>
            <br>
