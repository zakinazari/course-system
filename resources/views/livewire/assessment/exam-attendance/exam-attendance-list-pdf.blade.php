...
<table width="100%">
    <tr>
        ...
        <td width="60%" style="text-align:center;">
            ...
            <p style="font-size:20px; font-weight:bold; margin:3px 0 0 0;">{{ __('label.exam_attendance') }}</p>
            <p style="font-size:20px; font-weight:bold; margin:3px 0 0 0;">{{ $course?->name }}</p>
            <p style="font-size:20px; font-weight:bold; margin:3px 0 0 0;">{{__('label.exam_type')}}: {{ $exam_type?->name }}</p>
