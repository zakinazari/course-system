                ...
                <form @if($editMode) wire:submit.prevent="update" @else wire:submit.prevent="store" @endif>
                    <div class="modal-body"  style="height:500px; overflow-y:auto;">
                         ...
                         <div class="mb-3" >
                              ...
                              <select class="form-select select2"  wire:model.lazy="employee_id" id="employee_id" wire:ignore>
                         ...
                         <div class="mb-3">
                              ...
                              <select wire:model.lazy="position_id" class="form-control select2" id="position_id" wire:ignore>
                                   <option value="">{{ __('label.select') }}</option>
                                   @foreach($positions as $position)
