            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($gazettes as $i => $gazette)
                        <tr>
                            <td>{{ ($gazettes->currentPage() - 1) * $gazettes->perPage() + $i + 1 }}</td>
                            <td>
                                ...
                                <div class="dropdown position-static">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(edit(Auth::user()->role_ids,$active_menu_id))
                                            <a class="dropdown-item" href="javascript:void(0);" wire:click="edit({{ $gazette->id }})"
                                            ><i class="bx bx-edit-alt me-1 text-success"></i>{{ __('label.edit') }}</a>
                                        @endif
                                        @if(delete(Auth::user()->role_ids,$active_menu_id))
                                            <a class="dropdown-item " href="javascript:void(0);"  onclick="confirmDelete({{ $gazette->id }},'{{$table_name}}')"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input name="status" 
                                        ...
                                        wire:model.lazy="status"  @checked($status == 1)>
                       ...
                       <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group mb-2">
                                    <input type="file" class="form-control @error('files.*') is-invalid @enderror" id="fileInput" multiple wire:model.lazy="files">
                                </div>
                        ...
                        @foreach($existing_files as $f)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button onclick="confirmDelete({{ $f->id }},'gazette_files')" type="button" class="btn btn-icon btn-label-danger">
