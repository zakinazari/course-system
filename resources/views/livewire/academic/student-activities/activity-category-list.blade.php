            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($activity_categories as $i => $category)
                        <tr>
                            <td>{{ ($activity_categories->currentPage() - 1) * $activity_categories->perPage() + $i + 1 }}</td>
                            <td>{{ $category->name }}</td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="category" id="nameBasic" class="form-control @error('name') is-invalid @enderror" wire:model.lazy="name">
                          ...
                          <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" wire:model.lazy="type" id ="" >
                                <option value="">{{ __('label.select') }}</option>
                                    <option value="positive">{{ __('label.positive') }}</option>
                                    <option value="negative">{{ __('label.negative') }}</option>
                                    <option value="neutral">{{ __('label.neutral') }}</option>
                                </select>
