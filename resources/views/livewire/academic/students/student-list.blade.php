                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" wire:model.defer="search.status" id ="">
                           <option value="">{{ __('label.all') }}</option>
                            ...
                            <option value="suspended">{{ __('label.suspended') }}</option>
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge bg-label-success me-1" style="font-size:10px;">{{ ucfirst($student->status) }}</span>
                                ...
                                <div class="dropdown position-static">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(edit(Auth::user()->role_ids,$active_menu_id))
                                            <a class="dropdown-item" href="javascript:void(0);" wire:click="edit({{ $student->id }})"
                        ...
                        <div class="row" wire:ignore>
                            <div class="col mb-3">
                                ...
                                <select id="visitor_id" class="form-select select2" wire:model.lazy ="visitor_id">
                                    <option value="">Select information from visitor list</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
