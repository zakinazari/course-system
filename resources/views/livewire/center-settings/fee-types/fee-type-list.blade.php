            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($fee_types as $i => $fee)
                        <tr>
                            <td>{{ ($fee_types->currentPage() - 1) * $fee_types->perPage() + $i + 1 }}</td>
                            <td>{{ $fee->name }}</td>
                            <td>{{ $fee->code }}</td>
                ...
                <form @if($editMode) wire:submit.prevent="update" @else wire:submit.prevent="store" @endif>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                <label for="nameBasic" class="form-label">{{ __('label.code') }} <span style="color:red;">*</span></label>
