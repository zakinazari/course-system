...
class Helpers
{
  public static function appClasses()
  {
    ...
    $DefaultData = [
      'myLayout' => 'vertical',
      'myTheme' => session('myTheme', 'theme-semi-dark'),
      'myStyle' => session('myStyle', 'light'),
      'myRTLSupport' => true,
      'myRTLMode' => true,
      'hasCustomizer' => true,
  ...
  public static function updatePageConfig($pageConfigs)
  {
    ...
    public static function setStyle($style)
    {
        ...
        if(!in_array($style, ['light', 'dark'])) $style = 'light';

        session(['myStyle' => $style]);
        if($style==='dark'){
            session(['myTheme' => 'theme-default']);
        }else{
            session(['myTheme' => 'theme-semi-dark']);
        }
    }
}
