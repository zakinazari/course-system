...
use Auth;
use DB;
class EmployeePermanentPayrollList extends Component
{
    ...
    public function mount($active_menu_id = null,$employee_id= null)
    {
        ...
        $this->modalId= 'employee-permanent-payroll-list-addEditModal';
    }
    ...
    {
        $search = $this->search;
        $payrolls = PermanentPayroll::with('month')
        ...
        return view('livewire.hr.employees.personal-payrolls.employee-permanent-payroll-list',compact('payrolls'));
    }
    ...
    {
        $this->show_payroll_details = PermanentPayroll::with('employee:id,name,last_name,employee_code','month')->find($id);
    ...
    public function delete($id)
    {
        ...
        try {
            $payroll = PermanentPayroll::findOrFail($id);
