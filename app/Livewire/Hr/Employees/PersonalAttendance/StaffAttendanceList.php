...
class StaffAttendanceList extends Component
{
    ...
    public $active_menu;
    public $modalId = 'staff-attendance-addEditModal';
    ...
    public function render()
    {
        ...
        $search = $this->search;
        $attendances = EmployeeAttendance::with('leaveType')
        ...
        return view('livewire.hr.employees.personal-attendance.staff-attendance-list',compact('attendances'));
    }
    ...
    public function update()
    {
        ...
        try {
            ...
            $attendance = EmployeeAttendance::with('employee')->findOrFail($this->attendance_id);
            ...
            SystemLog::create([
                ...
                ' | Employee ID: ' . $attendance->employee->employee_code .
