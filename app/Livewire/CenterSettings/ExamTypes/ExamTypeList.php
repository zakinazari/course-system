...
namespace App\Livewire\CenterSettings\ExamTypes;
...
use Auth;
class ExamTypeList extends Component
{
    // -------start generals--------------------
    use WithPagination;
    public $perPage = 10;
    ...
    public $active_menu;
    public $modalId = 'exam-type-list-addEditModal';
    public $table_name='exam-types';
    ...
    public function store()
    {
        ...
        try {
            ...
            SystemLog::create([
                ...
                'section' => __('label.exam_type').' ('.$exam_type->name.' ID:'.$exam_type->id.')',
                'type_id' => 2,
            ]);
            // ---end system log-------------
            $this->closeModal();
